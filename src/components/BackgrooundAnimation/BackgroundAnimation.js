...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class ExternalForce extends ShaderPass {
      constructor(simProps) {
        super({ output: simProps.dst }); this.scene = new THREE.Scene(); this.camera = new THREE.Camera();
    ...
    class WebGLManager {
      ...
      init() { this.props.$wrapper.prepend(Common.renderer.domElement); this.output = new OutputPass(); }
